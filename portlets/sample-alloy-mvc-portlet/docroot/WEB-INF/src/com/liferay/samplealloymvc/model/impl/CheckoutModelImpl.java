...
/**
 * The base model implementation for the Checkout service. Represents a row in the &quot;SAM_Checkout&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CheckoutModelImpl extends BaseModelImpl<Checkout>
	 ...
	 */
	public static final String TABLE_NAME = "SAM_Checkout";
	...
	public static final String TABLE_SQL_CREATE = "create table SAM_Checkout (checkoutId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,assetId LONG,checkOutDate DATE null,expectedCheckInDate DATE null,actualCheckInDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table SAM_Checkout";
	public static final String ORDER_BY_JPQL = " ORDER BY checkout.checkoutId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY SAM_Checkout.checkoutId ASC";
