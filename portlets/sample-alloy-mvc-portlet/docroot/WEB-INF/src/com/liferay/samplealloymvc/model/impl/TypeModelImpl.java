...
import com.liferay.samplealloymvc.model.TypeModel;
...
/**
 * The base model implementation for the Type service. Represents a row in the &quot;SAM_Type&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TypeModelImpl extends BaseModelImpl<Type> implements TypeModel {
	 ...
	 */
	public static final String TABLE_NAME = "SAM_Type";
	...
	public static final String TABLE_SQL_CREATE = "create table SAM_Type (typeId LONG not null primary key,groupId LONG,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table SAM_Type";
	public static final String ORDER_BY_JPQL = " ORDER BY type.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY SAM_Type.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.samplealloymvc.model.Type"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.samplealloymvc.model.Type"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = false;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.samplealloymvc.model.Type"));
